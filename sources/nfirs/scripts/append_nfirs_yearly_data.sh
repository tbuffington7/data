...
ogr2ogr -f PostgreSQL PG:dbname=$DB Incident_address_${YEAR}_aa.shp
#ogr2ogr -f PostgreSQL PG:dbname=$DB address_to_geo_aa_2013_USA.shp
ogr2ogr -f PostgreSQL PG:dbname=$DB Incident_address_${YEAR}_ab.shp   # ab has dbf issue @ record 494357 / 499999
#ogr2ogr -f PostgreSQL PG:dbname=$DB address_to_geo_ab_2013_USA.shp
ogr2ogr -f PostgreSQL PG:dbname=$DB Incident_address_${YEAR}_ac.shp
#ogr2ogr -f PostgreSQL PG:dbname=$DB address_to_geo_ac_2013_USA.shp
ogr2ogr -f PostgreSQL PG:dbname=$DB Incident_address_${YEAR}_ad.shp
#ogr2ogr -f PostgreSQL PG:dbname=$DB address_to_geo_ad_2013_USA.shp
ogr2ogr -f PostgreSQL PG:dbname=$DB Incident_address_${YEAR}_ae.shp
