CREATE MATERIALIZED VIEW IF NOT EXISTS department_nfirs.buildingfires AS
  ...
  FROM department_nfirs.basicincident b
    INNER JOIN department_nfirs.fireincident f
